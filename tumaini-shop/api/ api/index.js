...
/* ---------------- notifications (polling instead of a live push) ----------------
   Vercel functions don't hold a connection open, so instead of alerting staff
   the instant something happens, the frontend asks "anything new?" every few
   seconds. This endpoint just hands back the most recent event. */
